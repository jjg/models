...
module panel(){
    ...
    difference(){
        ...
        translate([BASE_LENGTH*.60+FRAME_THICKNESS,BASE_WIDTH*.53+FRAME_THICKNESS,-1]){
            ...
            translate([(subpanel_length/2)-(15/2),(subpanel_width/2)-(23/2),-WALL_THICKNESS-1]){
                // TODO: Consider pulling this out into an LED voltmeter module
                cube([15,23,WALL_THICKNESS*3]);
            }
            translate([0,0,WALL_THICKNESS]){
